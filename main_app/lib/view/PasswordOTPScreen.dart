...
import '../controllers/accounts_controllers/verify_otp_conroller.dart';
...
class _PasswordOtpScreenState extends State<PasswordOtpScreen> {
  ...
  late ResetFlowOtpController otpController;
  late String phone;
  ...
  void initState() {
    ...
    otpController = Get.put(ResetFlowOtpController(phone));
  }
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        GetBuilder<ResetFlowOtpController>(
                          builder: (_) {
                            return Wrap(
                              spacing: 8,
                              runSpacing: 8,
